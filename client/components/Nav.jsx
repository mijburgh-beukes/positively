    ...
    <div className="nav d-flex flex-lg-column flex-lg-row rounded-3 ">
      ...
      <NavLink to="/">
        ...
        <svg
          ...
          height="16"
          fill="currentColor"
          className="bi bi-columns-gap active m-3"
          viewBox="0 0 16 16">
      ...
      <NavLink to="/user/:id">
        {/* <img src="./src/profile.svg" alt="profile" className="inactive"/> */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
      ...
      <NavLink to="/edithabits">
        {/* <img src="./src/edit-habit.svg" alt="edit-habit" className="inactive"/> */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
